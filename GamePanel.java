import java.awt.*;
 ...
 public class GamePanel extends JPanel implements Runnable{
     ...
     GamePanel(){// default constructor of the class
         ...
         gameThread.start();//Thread starts executing following methods simulataneously
     }
     ...
     //keyboard keys are pressed/releaed
     {
         ...
         //when key S,X or up/down arrow is pressed by user paddle's will move
         {
